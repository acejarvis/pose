...
namespace NuitrackSDK.Frame
{
    ...
    public static class FrameOverloadUtils
    {
        ...
        public static RenderTexture ToRenderTexture(this DepthFrame frame, TextureCache textureCache = null)
        {
        ...
        public static Texture2D ToTexture2D(this DepthFrame frame, TextureCache textureCache = null)
        {
        ...
        /// and not a cached version, pass a reference to the local texture (may affect performance)</param>
        /// <returns>Texture = (RenderTexture or Texture2D)</returns>
        public static Texture ToTexture(this DepthFrame frame, TextureCache textureCache = null)
        {
